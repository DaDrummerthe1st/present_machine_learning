...
with description:  # tab
    ...
    st.subheader('Differentiate Pictures for auto sync --> GitHub')
    st.markdown(
    ...
    Tanken med Dpfas är att kategorisera bilder i väldigt många dimensioner.
    En bild innehåller t ex metadata, bl a i form av exif-data.
    - 
    """)
