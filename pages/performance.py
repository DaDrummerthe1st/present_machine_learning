...
st.header("Prestanda, förenklingar och ekonomi")
st.write("""
...
st.markdown("""
### Lite för hand nedtecknade prestanda
...
performance_chart = {
    'tidsåtgång':{'Linus 100\' rader multiplicerat med 10 weights':f'{5/60/60}','klassbilden':f'{time_to_process_one_picture_with_yolo_object_detection}'}
}
st.write(performance_chart)
